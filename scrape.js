// Web scraper for Google Scholar profiles
// Based on work by Allison McCoy (Vanderbilt) and Jimmy Lin (University of Waterloo)
...
var scrapeEntry = function(person, doneCallback) {
  ...
  // Properly set the encoding to handle accented characters
  request({ encoding: 'binary', method: "GET", uri: url}, function(err, resp, body) {
    ...
    // Adding a timeout to regulate scraping speed (1 second per request)
    setTimeout(function() {
...
// Scrape all researchers in series
